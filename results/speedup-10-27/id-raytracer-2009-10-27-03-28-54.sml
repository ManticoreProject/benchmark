structure id_raytracer2009_10_27_03_28_54 : EXPERIMENT = struct
...
val datetime = "2009-10-27 03:28:54"
...
val runs =
		...
		{ n_procs=0,		time_sec=5.503,		gc=[], 		cpu_time_sec=NONE,		max_space_bytes=NONE} ::
		{ n_procs=0,		time_sec=5.501,		gc=[], 		cpu_time_sec=NONE,		max_space_bytes=NONE} ::
		...
		{ n_procs=0,		time_sec=5.505,		gc=[], 		cpu_time_sec=NONE,		max_space_bytes=NONE} ::
		{ n_procs=0,		time_sec=5.507,		gc=[], 		cpu_time_sec=NONE,		max_space_bytes=NONE} ::
		{ n_procs=0,		time_sec=5.578,		gc=[], 		cpu_time_sec=NONE,		max_space_bytes=NONE} ::
		{ n_procs=0,		time_sec=5.503,		gc=[], 		cpu_time_sec=NONE,		max_space_bytes=NONE} ::
		{ n_procs=0,		time_sec=5.511,		gc=[], 		cpu_time_sec=NONE,		max_space_bytes=NONE} ::
		nil

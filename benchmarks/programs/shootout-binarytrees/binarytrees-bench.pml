...
fun mk 0 i = Node (Nil, i, Nil)
  | mk d i = Node (mk (d-1) (i*2-1), i, mk (d-1) (i*2))

fun chk Nil = 0
  | chk (Node (l, i, r)) = i + chk l - chk r
...
(* FIXME: results come out in reverse order! *)
fun loopDepths d =
    if d > max' then ()
             ...
             val (a, rest) = (| lp (0, 0), loopDepths (d+2) |)
         in msg (Int.toString (2*n)^"\t trees of depth ") d a ; rest end

...
structure BlackScholes : sig
  ...
  local
    ...
    fun std_normal_pdf x = normalization_factor * MyBasis.exp (~0.5 * x * x)
  ...
  in
    ...
    fun std_normal_cdf x = if x < 0.0
               ...
               TextIO.print ("magic_poly " ^ (Double.toString x) ^ " = " ^
               (Double.toString (magic_poly x)) ^ "\t");
               *)
  ...
  fun price (Option (
	...
	val debug_print = String.concat [
		"log_term = ", (Double.toString log_term), "\ttime_term =",
		(Double.toString time_term), "\tdenom = ", (Double.toString denom),
		"\nd1 = ", (Double.toString d1), "\td2 = ", (Double.toString d2), 
		"\tn_d1 = ", (Double.toString n_d1), "\tn_d2 = ", (Double.toString n_d2),
		"\n"
	      ]
